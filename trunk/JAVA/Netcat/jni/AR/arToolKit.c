...
char           *cparam_name    = "/data/data/edu.dhbw.andopenglcam/camera_para.dat";
ARParam         cparam;

//pattern-file
char           *patt_name      = "/data/data/edu.dhbw.andopenglcam/4x4_100.patt"; 
int		cur_marker_id = -1;
int             patt_id;
...
JNIEXPORT void JNICALL Java_edu_dhbw_andopenglcam_MarkerInfo_artoolkit_1init
  (JNIEnv *env, jobject object, jint imageWidth, jint imageHeight, jint screenWidth, jint screenHeight) {
	...
	__android_log_write(ANDROID_LOG_ERROR,"AR", cparam_name);
