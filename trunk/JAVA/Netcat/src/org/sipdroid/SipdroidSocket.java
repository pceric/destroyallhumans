 ...
 * 
 * Sipdroid is free software; you can redistribute it and/or modify it under the
 ...
 * this source code; if not, write to the Free Software Foundation, Inc., 59
...
public class SipdroidSocket extends DatagramSocket
{
  ...
  {
    if (loaded)
      impl.setOption(SocketOptions.SO_TIMEOUT, val);
    else
