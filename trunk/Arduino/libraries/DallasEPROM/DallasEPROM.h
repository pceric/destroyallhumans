...
// OneWire commands
#define READSTATUS      0xAA  // Read the status fields or the Scratchpad
#define WRITESTATUS     0x55  // Write to the status fields or commit Scratchpad
...
public:
	 ...
	 * 
	 * @param rWire Reference to a OneWire v2.0 instance.
	 */
...
private:
	OneWire* _wire;  // Pointer to OneWire v2.0 instance
